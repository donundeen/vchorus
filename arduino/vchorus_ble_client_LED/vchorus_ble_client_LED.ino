...
static void notifyCallback(
  ...
  /*
    ...
    */
    ...
    // illuminateLEDS(lower);
  }


// Althea's stuff
 
 void illuminateLEDS(int raw) {
...
/*
  ...
  */
  ...
  int ledvalue = map(raw, 0, 1000, 0, 1800);
  /*Serial.print("Min ");
  ...
  */
  ...
  n   = ledvalue;                        // Raw reading from mic / lower value
  ...
  for(i=0; i<N_PIXELS; i++) {
    if(i >= height){
      ...
      */
      ...
      Serial.print(i);
      Serial.print(" : " );
      Serial.println(Wheel(map(i,0,strip.numPixels()-1,30,150)));
      */
...
// Every few frames, make the peak pixel drop by 1:
  ...
  vol[volCount] = lvl;                      // Save sample for dynamic leveling
